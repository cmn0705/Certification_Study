...
def practice_aws_cp():
    ...
    if session.get('num_aws_cp')==None: session['num_aws_cp']=''
    ...
    if request.method=='GET':
        ...
        session['num_aws_cp']=len(list_id)
        notice,explain='',''
        return render_template('practice_aws_cp.html', notice=notice, explain=explain)
    ...
    else: return render_template('practice_aws_cp.html', notice=notice, explain=explain)